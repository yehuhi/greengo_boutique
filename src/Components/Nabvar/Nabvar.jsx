  ...
  return (
    <div className="navbar">
      ...
      <ul className="nav-menu">
        <li
          className={`link ${location.pathname === '/'
            ? 'active'
            : 'inactive'}`}
        >
        ...
        <li
          className={`link ${location.pathname === '/womens'
            ? 'active'
            : 'link'}`}
        >
        ...
        <li
          className={`link ${location.pathname === '/mens'
            ? 'active'
            : 'inactive'}`}
        >
        ...
        <li
          className={`link ${location.pathname === '/kids'
            ? 'active'
            : 'inactive'}`}
        >
            ...
            {(cart.length && cart.length >= 0) || cartItemsLenght
              ? <div className="cart-counter">
                  <span className="count">
                    {cart.length ? cart.length : cartItemsLenght}
                  </span>
                </div>
              : ''}
          </div>
              ...
              >
                ...
                <li
                  className={`link ${location.pathname === '/womens'
                    ...
                    : 'link'}`}
                >
                  <NavLink to="/womens" onClick={() => setOpenMenu(false)}>
                    MUJERES
                  </NavLink>
                </li>
                <li
                  className={`link ${location.pathname === '/mens'
                    ...
                    : 'inactive'}`}
                >
                  <NavLink to="/mens" onClick={() => setOpenMenu(false)}>
                    HOMBRES
                  </NavLink>
                </li>
                <li
                  className={`link ${location.pathname === '/kids'
                    ...
                    : 'inactive'}`}
                >
                  <NavLink to="/kids" onClick={() => setOpenMenu(false)}>
                    NIÑOS
                  </NavLink>
                </li>
              </ul>
