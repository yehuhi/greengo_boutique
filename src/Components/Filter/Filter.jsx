  ...
  const handleCheckboxChange = (checkboxType, data) => {
    ...
    if (data.checked) {
      ...
      if (checkboxType === 'category') {
        ...
        setFiltered(prevFiltered => ({
          ...prevFiltered,
          categories: prevFiltered.categories.filter(
      ...
      <div className="div-ul">
        <ul className="ul-filter">
          <li className="li-filter-up">
            <div
              className="cate-plus"
              onClick={() => setOpenMenuCat(!openMenuCat)}
            >
          ...
          <li className="li-filter-up">
            <div
              className="cate-plus"
              onClick={() => setOpenMenuBran(!openMenuBran)}
            >
            ...
            {openMenuBran
              ? <div className="open-menu">
                  {Array.isArray(data[0].brands) &&
                    data[0].brands.map((item, index) =>
                      <div
                        className="prevent-select"
                        style={{ display: 'flex' }}
                        key={index}
                      >
                        <input
                          ...
                          checked={filtered.brands.includes(item)}
                        />
                        <span className="label-input">
                          {item}
                        </span>
          ...
          <li className="li-filter-up">
            <div
              className="cate-plus"
              onClick={() => setOpenMenuPric(!openMenuPric)}
            >
                    ...
                    data[0].prices.map((item, index) =>
                      ...
                      >
                        <input
                          ...
                          checked={filtered.prices.includes(item)}
                        />
                        <span className="label-input">
                          {item}
                        </span>
          ...
          <li className="li-filter-up">
            <div
              className="cate-plus"
              onClick={() => setOpenMenuColo(!openMenuColo)}
            >
                    ...
                    data[0].colors.map((item, index) =>
                      ...
                      >
                        <input
                          ...
                          checked={filtered.colors.includes(item)}
                        />
                        <span className="label-input">
                          {item}
                        </span>
          ...
          <li className="li-filter-up">
            <div
              className="cate-plus"
              onClick={() => setOpenMenuSiz(!openMenuSiz)}
            >
            ...
            {openMenuSiz
              ? <div className="open-menu">
                  {Array.isArray(data[0].sizes) &&
                    data[0].sizes.map((item, index) =>
                      <div
                        className="prevent-select"
                        style={{ display: 'flex' }}
                        key={index}
